...
/**
 * Entidad para reinicar el password 
 * @author Hector
 *
 */
@Entity
@Table(name="reinicios_password")
public class ReinicioPasswordToken implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4392366201189299399L;
	...
	public ReinicioPasswordToken() {
		
	}
	
	public ReinicioPasswordToken(String token,LocalDateTime expira) {
		super();
		this.token = token;
		this.expira = expira;
	}
	 ...
	 * @param usuario
	 */
	public ReinicioPasswordToken(String token, LocalDateTime creado, LocalDateTime expira, Usuario usuario) {
		super();
		this.token = token;
		this.creado = creado;
		this.expira = expira;
	...
	public String toString() {
		...
		builder.append("ReinicioPasswordToken [id=");
		builder.append(id);
